...
function publishArticle_(input){
 ...
 return{slug:slug,path:path,commit:manifest.commit||saved.commit,articleCommit:saved.commit,manifestPath:manifestPath,htmlUrl:'https://onestopfzd.in/gauravs-world/article-dynamic.html?id='+encodeURIComponent(slug)};
}
